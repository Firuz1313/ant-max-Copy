...
const testSteps = [
  ...
  },
  {
    ...
    device_id: "openbox_standard",
    step_number: 2,
    title: "Проверьте п��тание приставки",
    description: "Убедитесь, ч��о приставка включена и получает питание",
    instruction:
  ...
  },
  {
    ...
    description: "Убедитесь, что пульт передает сигнал",
    instruction:
      "Направьте пульт на приставку и нажмите любую кнопку. Если есть смартфон с камерой, посмотрите через камеру на ИК-диод пульта при нажатии кнопки - должен мигать красный свет.",
    estimated_time: 60,
...
export const seedDatabase = async () => {
  try {
    ...
    await transaction(async (client) => {
      ...
      console.log("📋 Добавление диагностических шагов...");
